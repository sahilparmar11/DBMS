...
('NORTH AMERICA','WATCH',1500,'2023'),('EUROPE','MOBILE',1200,'2023'),
('ASIA','WATCH',1800,'2023'),('NORTH AMERICA','TV',900,'2024'),
('EUROPE','WATCH',2000,'2024'),('ASIA','MOBILE',1000,'2024'),
('NORTH AMERICA','MOBILE',1600,'2023'),('EUROPE','WATCH',1500,'2023'),
('ASIA','TV',1100,'2024'),('NORTH AMERICA','WATCH',1700,'2024');
...
SELECT DISTINCT REGION, SUM(SALES_AMOUNT)
FROM SALES_DATA
WHERE YEAR = 2024
GROUP BY REGION
LIMIT 3;
...
SELECT REGION , MAX(SALES_AMOUNT) AS HIGHESTSALES
FROM SALES_DATA
GROUP BY REGION;
